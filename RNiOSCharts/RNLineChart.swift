...
class RNLineChart : LineChartView {
  ...
  func setConfig(config: String!) {
    ...
    if json["dataSets"].isExists() {
        ...
        if tmp["values"].isExists() {
          ...
          if json["valueFormatter"].isExists() {
            if json["valueFormatter"]["minimumDecimalPlaces"].isExists() {
              self.minimumDecimalPlaces = json["valueFormatter"]["minimumDecimalPlaces"].intValue;
            }
            if json["valueFormatter"]["maximumDecimalPlaces"].isExists() {
              self.maximumDecimalPlaces = json["valueFormatter"]["maximumDecimalPlaces"].intValue;
            }
            ...
            if json["valueFormatter"]["type"].isExists() {
              ...
              case "regular":
                ...
                break;
              case "abbreviated":
                dataSet.valueFormatter = ABNumberFormatter(minimumDecimalPlaces: self.minimumDecimalPlaces, maximumDecimalPlaces: self.maximumDecimalPlaces);
                break;
              default:
                dataSet.valueFormatter = NSNumberFormatter();
              }
            ...
            dataSet.valueFormatter?.minimumFractionDigits = self.minimumDecimalPlaces;
            dataSet.valueFormatter?.maximumFractionDigits = self.maximumDecimalPlaces;
          }
      ...
      let chartData = LineChartData(xVals: self.labels, dataSets: sets);
      self.data = chartData;
    }
    ...
    if json["valueFormatter"].isExists() {
      ...
      if json["valueFormatter"]["type"].isExists() {
        ...
        case "regular":
          ...
          break;
        case "abbreviated":
          self.leftAxis.valueFormatter = ABNumberFormatter(minimumDecimalPlaces: self.minimumDecimalPlaces, maximumDecimalPlaces: self.maximumDecimalPlaces);
          self.rightAxis.valueFormatter = ABNumberFormatter(minimumDecimalPlaces: self.minimumDecimalPlaces, maximumDecimalPlaces: self.maximumDecimalPlaces);
          break;
        default:
          self.leftAxis.valueFormatter = NSNumberFormatter();
          self.rightAxis.valueFormatter = NSNumberFormatter();
      ...
      self.leftAxis.valueFormatter?.minimumFractionDigits = self.minimumDecimalPlaces;
      self.rightAxis.valueFormatter?.minimumFractionDigits = self.minimumDecimalPlaces;
      self.leftAxis.valueFormatter?.maximumFractionDigits = self.maximumDecimalPlaces;
      self.rightAxis.valueFormatter?.maximumFractionDigits = self.maximumDecimalPlaces;
    }
